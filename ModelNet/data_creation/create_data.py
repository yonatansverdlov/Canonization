...
def main():
    ...
    train_path = os.path.join("data", f"{tag}_train_P{P}_hilbm{hilbert_m}_norm_with_perms.pt")
    test_path  = os.path.join("data", f"{tag}_test_P{P}_hilbm{hilbert_m}_norm_with_perms.pt")
